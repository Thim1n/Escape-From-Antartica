...
function getPlayerID() {
    // Récupérer l'ID de l'utilisateur actuel depuis le backend
    // Vous pouvez stocker l'ID dans une variable globale ou le passer en paramètre
    // Remplacez cette valeur par l'ID de l'utilisateur actuel
    return "123456";
}
...
function vicotryAPI() {
    ...
    const data = {
        score: player.coins,
        userId: ,  // Remplacez par l'ID de l'utilisateur actuel
        time: gameTime
    };
