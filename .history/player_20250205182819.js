class Player {
  ...
  update(platforms, doors) { // Ajouter doors comme paramètre
      ...
      for (let door of doors) {
          if (!door.isOpen) { // Seulement vérifier les portes fermées
...
class AnimationManager {
  ...
  updateAnimation() {
      if (this.isIdle) {
          ...
          this.playerElement.style.backgroundPosition = `-${this.currentFrame * 50}px -50px`;
