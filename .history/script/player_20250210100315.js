class Player {
  ...
  animateWalk(){
    while (this.isWalking{
      if (this.sprite == '../assets/sprite/enemy.png'){
      this.sprite = '../assets/sprite/enemy2.png'
      }
      else if(this.sprite == '../assets/sprite/enemy2.png'){
        this.sprite = '../assets/sprite/enemy.png'
      }
      time.sleep(0.3)
    }
  }
